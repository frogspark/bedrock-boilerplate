...
<head>
  ...
  <link rel="stylesheet" href="/app/themes/frogspark/scss/dist/bundle.min.css?v=<?php echo time(); ?>" type="text/css"
    media="all" />
  ...
  <script async
    src="https://www.googletagmanager.com/gtag/js?id=<?php if (get_field('google_analytics_id', 'option')): the_field('google_analytics_id', 'option'); endif; ?>">
  </script>
  <script>
