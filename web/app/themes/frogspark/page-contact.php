  ...
  <div class="container py-15">
      <div class="row">
          ...
          <div class="offset-lg-1 col-lg-5 pt-10 pt-lg-0">
              <h3>Call us</h3>
              <p><a href="tel:<?php echo the_field('phone_number', 'options'); ?>"><?php echo the_field('phone_number', 'options'); ?></a>
              </p>
              <h3>Text Us</h3>
              <p><a href="tel:<?php echo the_field('phone_number', 'options'); ?>"><?php echo the_field('phone_number', 'options'); ?></a>
              </p>
              <h3>Email us</h3>
              <p><a href="mailto:<?php echo the_field('email', 'options'); ?>"><?php echo the_field('email_address', 'options'); ?></a>
              </p>
